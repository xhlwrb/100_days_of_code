...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', mode='a', newline='', encoding='utf8') as csv_file:
            cafe_writer = csv.writer(csv_file, delimiter=',')
            cafe_writer.writerow([form.cafe.data,
                                 form.location.data,
                                 form.open.data,
                                 form.close.data,
                                 form.coffee.data,
...
def cafes():
    ...
    return render_template('cafes.html', table_head=table_head, list_of_rows=list_of_rows)
